...
const AddPage = () => {
    ...
    return (
        <>
            ...
            <div className="fixed top-[5%] left-[5%] bottom-[5%] right-[5%] overflow-visible bg-white bg-opacity-20 rounded-lg shadow-lg backdrop-blur-sm border border-white border-opacity-30 text-white p-4">
                <div className='flex-col h-full justify items-center'>
                    ...
                    <form onSubmit={handleSubmit} className=" *:mx-[10%] font-mono font-medium text-lg grid grid-cols-2 gap-4 h-full">
                        <h1 className="text-black text-6xl mx-0 font-bold mb-8 col-span-2 flex justify-center items-center">Create Ticket</h1>
